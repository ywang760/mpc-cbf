...
namespace mpc {
    ...
    public:
        ...
        using PieceIndexAndParameter = typename mpc::PiecewiseBezierMPCQPOperation<T, DIM>::PieceIndexAndParameter;
        using BezierQPOperations = typename mpc::PiecewiseBezierMPCQPOperation<T, DIM>::BezierQPOperations;
        ...
        using CostAddition = typename mpc::PiecewiseBezierMPCQPOperation<T, DIM>::CostAddition;
        using LinearConstraint = typename mpc::PiecewiseBezierMPCQPOperation<T, DIM>::LinearConstraint;
        ...
        void addPiecewise(std::unique_ptr<PiecewiseBezierMPCQPOperation> &&piecewise_operations_ptr);
        size_t numPieces() const;
        const std::unique_ptr<PiecewiseBezierMPCQPOperation> &piecewise_operations_ptr() const;
        ...
        void addPositionErrorPenaltyCost(const State &current_state, const VectorDIM &target);
    ...
    private:
        ...
        std::unique_ptr<PiecewiseBezierMPCQPOperation> piecewise_operations_ptr_;
