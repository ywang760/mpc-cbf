...
PFApplications::processFovUpdate(ParticleFilter& filter, const math::VectorDIM<T, DIM>& ego_pos,
                                 const math::VectorDIM<T, DIM>& neighbor_pos, double fov_beta,
                                 double fov_Rs, double weight_reduction_factor) {
...
PFApplications::processFovUpdate<double, 2>(ParticleFilter& filter,
                                            const math::VectorDIM<double, 2>& ego_pos,
                                            const math::VectorDIM<double, 2>& neighbor_pos,
                                            double fov_beta, double fov_Rs,
                                            double weight_reduction_factor);

template std::pair<math::Vector<double>, math::Matrix<double>>
PFApplications::processFovUpdate<double, 3>(ParticleFilter& filter,
