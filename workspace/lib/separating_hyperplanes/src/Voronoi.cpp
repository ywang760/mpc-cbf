...
Hyperplane<T, DIM> voronoi(const VectorDIM<T, DIM>& first_position,
    ...
    VectorDIM direction_from_first_to_second = second_position - first_position;
...
template Hyperplane<double, 3U> voronoi<double, 3U>(const VectorDIM<double, 3U>&,
                                                    const VectorDIM<double, 3U>&);
template Hyperplane<float, 3U> voronoi<float, 3U>(const VectorDIM<float, 3U>&,
                                                  const VectorDIM<float, 3U>&);
template Hyperplane<double, 2U> voronoi<double, 2U>(const VectorDIM<double, 2U>&,
                                                    const VectorDIM<double, 2U>&);
template Hyperplane<float, 2U> voronoi<float, 2U>(const VectorDIM<float, 2U>&,
                                                  const VectorDIM<float, 2U>&);
