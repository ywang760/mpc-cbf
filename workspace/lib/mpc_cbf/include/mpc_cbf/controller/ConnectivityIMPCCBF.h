...
namespace mpc_cbf {
    ...
    public:
        ...
        using DoubleIntegrator = typename mpc_cbf::ConnectivityMPCCBFQPOperations<T, DIM>::DoubleIntegrator;
        ...
        using ConnectivityCBF = typename mpc_cbf::ConnectivityMPCCBFQPOperations<T, DIM>::ConnectivityCBF;
        ...
        ConnectivityIMPCCBF(Params &p, std::shared_ptr<DoubleIntegrator> model_ptr, std::shared_ptr<ConnectivityCBF> connectivity_cbf_ptr,
