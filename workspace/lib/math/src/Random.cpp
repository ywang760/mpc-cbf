...
template model::State<double, 2U> addRandomNoise<double, 2U>(const model::State<double, 2U>& state,
                                                             double pos_std, double vel_std);
template model::State<double, 3U> addRandomNoise<double, 3U>(const model::State<double, 3U>& state,
                                                             double pos_std, double vel_std);
template model::State<float, 2U> addRandomNoise<float, 2U>(const model::State<float, 2U>& state,
                                                           float pos_std, float vel_std);
template model::State<float, 3U> addRandomNoise<float, 3U>(const model::State<float, 3U>& state,
                                                           float pos_std, float vel_std);
