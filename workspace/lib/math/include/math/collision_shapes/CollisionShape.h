...
class CollisionShape {
  public:
    ...
    virtual std::vector<VectorDIM> convexHullPoints(const VectorDIM& position) const = 0;
    ...
    /**
         ...
         */
    virtual std::shared_ptr<CollisionShape<T, DIM>> inflate(T inflation_amount) const = 0;
