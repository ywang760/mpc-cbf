...
FovControl<T, DIM>::FovControl(std::shared_ptr<FovCBF> cbf, int num_robots, bool slack_mode,
                               T slack_cost, T slack_decay_rate)
...
template <typename T, unsigned int DIM>
bool FovControl<T, DIM>::optimize(VectorDIM& cbf_u, const VectorDIM& desired_u,
...
template <typename T, unsigned int DIM>
T FovControl<T, DIM>::distanceToEllipse(const VectorDIM& robot_pos, const Vector& target_mean,
